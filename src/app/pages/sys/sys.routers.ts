...
export const SYS_ROUTES: Routes = [
  ...
  { path: 'user', component: UserManageComponent, title: '用户管理', data: {shouldReuse: true}},
  { path: 'user/details', component: UserDetailsComponent, title: '用户详情'},
  { path: 'user-group', component: UserGroupManageComponent, title: '用户组管理', data: {shouldReuse: true}},
  { path: 'user-group/details', component: UserGroupDetailsComponent, title: '用户组详情'},
  { path: 'position', component: PositionManageComponent, title: '职位管理', data: {shouldReuse: true}},
  { path: 'position/details', component: PositionDetailsManageComponent, title: '职位详情'},
  { path: 'role', component: RoleManageComponent, title: '角色管理', data: {shouldReuse: true}},
